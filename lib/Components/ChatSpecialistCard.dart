...
import '../BLoC/ChatScreenCubit.dart';
import '../BLoC/DataManagerCubit.dart';
import '../screens/BookingScreen.dart';

class ChatSpecialistCard extends StatelessWidget {
  ChatSpecialistCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        var loggedInUser =
            BlocProvider.of<DataManagerCubit>(context).state.loggedInUser;
        BlocProvider.of<ChatScreenCubit>(context)
            .LoadCertainChats(loggedInUser, doctor_name);
        Navigator.pushNamed(context, MainChatScreen.id, arguments: doctor_name);
      },
      child: Padding(
